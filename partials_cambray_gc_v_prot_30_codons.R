...
#Load dataset
data1 <-read.csv("supplementary_codon_gc_32.csv")
...
pdf("Partials_Cambray_GC_v_prot.pdf")
plot(x,prot_by_codon[-1],col=mycolours,pch=20,xlab="Codon position",ylab ="Partial correlation, GC content v protein per RNA")
abline(h=0)
dev.off()